...
PRIVATE_GOOGLE_ACCESS_VIP_RANGES = _mod.PRIVATE_GOOGLE_ACCESS_VIP_RANGES
...
def test_private_google_access_vip_ranges_documented():
    """限定公開の Google アクセスで使う VIP レンジを参照できる。
    PSC のエンドポイントには自分で予約した内部 IP を使う"""
    assert PRIVATE_GOOGLE_ACCESS_VIP_RANGES["all-apis"] == "199.36.153.8/30"
    assert PRIVATE_GOOGLE_ACCESS_VIP_RANGES["vpc-sc"] == "199.36.153.4/30"
